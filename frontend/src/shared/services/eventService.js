...
const SEED_EVENTS = [
  {
    ...
    sponsors: 'Genesis, Hack Culture, VIT Pune',
    blurb: 'Genesis flagship 24-hour creator-first hackathon at Vishwakarma Institute of Technology (VIT), Pune. Featuring Agentic AI & Web3 tracks, 4 mentor rounds, and the signature Creator Challenge.',
