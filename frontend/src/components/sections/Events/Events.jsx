...
import { SAMVEDNA_HERO, NO_AGENDA_1_HERO, POSTER_2 } from "@/data/mediaAssets";
        ...
        <Tilt className="relative" max={4} glare>
            ...
            <div className="frame aspect-[16/10] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 flex items-center gap-2">
                    <span className="px-2.5 py-1 text-[10px] font-mono uppercase tracking-[0.2em] bg-background/70 backdrop-blur border border-border text-[var(--text)]">Past · Archived</span>
                </div>
